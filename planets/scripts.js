...
function burger(){
	if(document.getElementById("burg").classList.contains("menu")){
		document.getElementById("burg").classList.remove("menu");
		document.getElementById("burg").classList.add("cross");
		document.getElementById("nav_panel").classList.remove("notvisible_logo");
		document.getElementById("nav_panel").classList.add("visible_logo");
	}
	else{
		document.getElementById("burg").classList.remove("cross");
		document.getElementById("burg").classList.add("menu");
		document.getElementById("nav_panel").classList.remove("visible_logo");
		document.getElementById("nav_panel").classList.add("notvisible_logo");
	}
}
